package com.app.group.wheelview.view;
...
import com.app.group.wheelview.adapter.WheelAdapter;
import com.app.group.wheelview.interfaces.IPickerViewData;
import com.app.group.wheelview.listener.LoopViewGestureListener;
import com.app.group.wheelview.listener.OnItemSelectedListener;
import com.app.group.wheelview.timer.InertiaTimerTask;
import com.app.group.wheelview.timer.MessageHandler;
import com.app.group.wheelview.timer.SmoothScrollTimerTask;
import com.app.group.wheelview.R;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.wheelview_pickerview_textsize);//默认大小
        ...
        } else if (1 <= density && density < 1.5) {
            CENTER_CONTENT_OFFSET = 3.6F;
        } else if (1.5 <= density && density < 2) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.wheelview_pickerview, 0, 0);
            mGravity = a.getInt(R.styleable.wheelview_pickerview_wheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.wheelview_pickerview_wheelview_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.wheelview_pickerview_wheelview_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.wheelview_pickerview_wheelview_dividerColor, 0xFFd5d5d5);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_pickerview_wheelview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.wheelview_pickerview_wheelview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
