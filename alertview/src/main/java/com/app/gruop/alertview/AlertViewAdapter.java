...
public class AlertViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view==null){
            ...
            view=inflater.inflate(R.layout.alertview_item_alertbutton, null);
    ...
    class Holder {
        ...
        public void UpdateUI(Context context,String data,int position){
            ...
            if (mDestructive!= null && mDestructive.contains(data)){
                tvAlert.setTextColor(context.getResources().getColor(R.color.alertview_textColor_alert_button_destructive));
            }
            else{
                tvAlert.setTextColor(context.getResources().getColor(R.color.alertview_textColor_alert_button_others));
            }
        }
    }
}