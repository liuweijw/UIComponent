package com.app.group.pickerview.view;
...
import com.app.group.pickerview.R;
import com.app.group.pickerview.configure.PickerOptions;
import com.app.group.pickerview.listener.ISelectTimeCallback;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new com.app.group.pickerview.view.WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
        if (mPickerOptions.timeSelectChangeListener != null) {
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                @Override
                public void onTimeSelectChanged() {
                    try {
                        Date date = com.app.group.pickerview.view.WheelTime.dateFormat.parse(wheelTime.getTime());
    ...
    public void setLunarCalendar(boolean lunar) {
        try {
            int year, month, day, hours, minute, seconds;
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(com.app.group.pickerview.view.WheelTime.dateFormat.parse(wheelTime.getTime()));
            year = calendar.get(Calendar.YEAR);
            month = calendar.get(Calendar.MONTH);
            day = calendar.get(Calendar.DAY_OF_MONTH);
            hours = calendar.get(Calendar.HOUR_OF_DAY);
